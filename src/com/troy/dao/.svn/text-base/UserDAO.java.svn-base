...
public class UserDAO extends BaseHibernateDAO  {
    ...
    public List findByExample(User instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.troy.entity.User")
	...
	public List findByDefaultProjectId(Object defaultProjectId
	) {
		return findByProperty(DEFAULT_PROJECT_ID, defaultProjectId
		);
	}
